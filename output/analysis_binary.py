...
data_file = "binary_simec_out.csv"
...
#Csv file containing the data (left part of the e.c.)
data_file = "binary_simec_out_left.csv"
...
data_file = "binary_simec_out_right.csv"
...
x_level_set = np.linspace(-3.14, 3.14, 1000)
y_level_set = np.sin(x_level_set)+.792893#-1.*x_level_set*x_level_set+.3125#.1875
